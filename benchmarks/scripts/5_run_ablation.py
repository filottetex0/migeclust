...
for conf in tqdm(configs):
   ...
   num_projections = cfg['mige_proj_param']['num_projections']
   p_min = cfg['mige_proj_param']['p_min']
   p_max = cfg['mige_proj_param']['p_max']
   knn = cfg['mige_proj_param']['knn']
...
write_pickle(
    ...
    os.path.join(
      output_dir,
      "ablation_results"+timestamp+".pkl"
    )
)
